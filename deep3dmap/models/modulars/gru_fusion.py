...
from deep3dmap.core.utils.neucon_utils import sparse_to_dense_channel, sparse_to_dense_torch
from .sparse_cnn import ConvGRU
...
class GRUFusion(nn.Module):
    ...
    def forward(self, coords, values_in, inputs, scale=2, outputs=None, save_mesh=False):
        ...
        batch_size = len(inputs['img_metas']['fragment'])
        ...
        for i in range(batch_size):
            scene = inputs['img_metas']['scene'][i]  # scene name
