...
from engines.dist import is_main_process, master_only
from engines.fileio import FileClient, get_file_backend
from engines.logging import print_log
from engines.registry import HOOKS
from engines.utils import is_list_of, is_seq_of
...
class CheckpointHook(Hook):
    ...
    def before_train(self, runner) -> None:
        ...
        # it will not be removed util the release of Engine1.0
    ...
    def _publish_model(self, runner, ckpt_path: str) -> None:
        ...
        """
        from engines.runner import save_checkpoint
