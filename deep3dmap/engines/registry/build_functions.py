...
from engines.utils import ManagerMixin
from .registry import Registry

if TYPE_CHECKING:
    import torch.nn as nn

    from engines.optim.scheduler import _ParamScheduler
...
def build_from_cfg(
    ...
    Examples:
        >>> from engines import Registry, build_from_cfg
    ...
    if not isinstance(registry, Registry):
        raise TypeError('registry must be a engines.Registry object, '
        ...
        if isinstance(obj_type, str):
            ...
            if obj_cls is None:
                raise KeyError(
                    ...
                    'can be found at '
                    'https://engines.readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                )
...
def build_runner_from_cfg(cfg: Union[dict, ConfigDict, Config],
    ...
    Examples:
        >>> from engines.registry import Registry, build_runner_from_cfg
    ...
    assert isinstance(
        registry, Registry), ('registry should be a engines.Registry object',
                              f'but got {type(registry)}')
    ...
    scope = args.pop('_scope_', None)
    with registry.switch_scope_and_registry(scope) as registry:
        obj_type = args.get('runner_type', 'engines.Runner')
        if isinstance(obj_type, str):
            ...
            if runner_cls is None:
                raise KeyError(
                    ...
                    f'Please check whether the value of `{obj_type}` is '
                    'correct or it was registered as expected. More details '
                    'can be found at https://engines.readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                )
            ...
            if isinstance(scheduler_type, str):
                ...
                if scheduler_cls is None:
                    raise KeyError(
                        ...
                        'as expected. More details can be found at https://engines.readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                    )
