...
def count_registered_modules(save_path: Optional[str] = None,
    ...
    """Scan all modules in Engine's root and child registries and dump to
    json.
    ...
    import engines.dataset
    import engines.evaluator
    import engines.hooks
    import engines.model
    import engines.optim
    import engines.runner
    import engines.visualization  # noqa: F401

    registries_info = {}
    # traverse all registries in Engine
