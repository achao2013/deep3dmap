...
import engines
from engines.config import Config, ConfigDict
from engines.dataset import worker_init_fn as default_worker_init_fn
from engines.device import get_device
from engines.dist import (broadcast, get_dist_info, get_rank, init_dist,
                           is_distributed, master_only)
from engines.evaluator import Evaluator
from engines.fileio import FileClient, join_path
from engines.hooks import Hook
from engines.logging import MessageHub, MMLogger, print_log
from engines.model import (MMDistributedDataParallel, convert_sync_batchnorm,
                            is_model_wrapper, revert_sync_batchnorm)
from engines.optim import (OptimWrapper, OptimWrapperDict, _ParamScheduler,
                            build_optim_wrapper)
from engines.registry import (DATA_SAMPLERS, DATASETS, EVALUATOR, FUNCTIONS,
                               HOOKS, LOG_PROCESSORS, LOOPS, MODEL_WRAPPERS,
                               MODELS, OPTIM_WRAPPERS, PARAM_SCHEDULERS,
                               RUNNERS, VISUALIZERS, DefaultScope)
from engines.utils import digit_version, get_git_hash, is_seq_of
from engines.utils.dl_utils import (TORCH_VERSION, collect_env,
                                     set_multi_processing)
from engines.visualization import Visualizer
...
class Runner:
    ...
    Examples:
        >>> from engines.runner import Runner
        >>> cfg = dict(
    ...
    def __init__(
        ...
        default_scope: str = 'engines',
        randomness: Dict = dict(seed=None),
        experiment_name: Optional[str] = None,
        cfg: Optional[ConfigType] = None,
    ):
        self._work_dir = osp.abspath(work_dir)
        engines.mkdir_or_exist(self._work_dir)
        ...
        engines.mkdir_or_exist(self._log_dir)
    ...
    def from_cfg(cls, cfg: ConfigType) -> 'Runner':
        ...
        runner = cls(
            ...
            default_scope=cfg.get('default_scope', 'engines'),
    ...
    def build_param_scheduler(
        ...
        Examples:
            ...
            >>> schedulers
            [<engines.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f6966290>]  # noqa: E501
            ...
            >>> schedulers = runner.build_param_scheduler(scheduler_cfg)
            >>> schedulers
            [<engines.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f60dd3d0>,  # noqa: E501
            <engines.optim.scheduler.lr_scheduler.StepLR at 0x7f70f6eb6150>]
        ...
        .. _optimizer-docs:
           https://engines.readthedocs.io/en/latest/tutorials/optim_wrapper.html
        """
    ...
    def build_dataloader(dataloader: Union[DataLoader, Dict],
        ...
        # However, in engines, if `collate_fn` is not defined in
    ...
    def resume(self,
        ...
        if 'config' in checkpoint['meta']:
            config = engines.Config.fromstring(
    ...
    def save_checkpoint(
        ...
        Args:
            ...
            file_client_args (dict, optional): Arguments to instantiate a
                FileClient. See :class:`engines.fileio.FileClient` for
        ...
        meta.update(
            ...
            engines_version=engines.__version__ + get_git_hash())
    ...
    def _check_scheduler_cfg(
        ...
        Examples:
            ...
            >>> from engines.optim import MultiStepLR
