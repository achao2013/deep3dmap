...
from engines.registry import FUNCTIONS
from engines.structures import BaseDataElement

# FUNCTIONS is new in Engine v0.7.0. Reserve the `COLLATE_FUNCTIONS` to keep
# the compatibility.
...
def pseudo_collate(data_batch: Sequence) -> Any:
    ...
    a mini-batch of Tensor(s). However, in Engine, ``pseudo_collate``
