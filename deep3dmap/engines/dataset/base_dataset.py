...
from engines.fileio import list_from_file, load
from engines.logging import print_log
from engines.registry import TRANSFORMS
from engines.utils import is_abs
...
class BaseDataset(Dataset):
    r"""BaseDataset for open source projects in Deep3dMap.
    ...
    def load_data_list(self) -> List[dict]:
        ...
        If the annotation file does not follow `Deep3dMap 2.0 format dataset
        <https://engines.readthedocs.io/en/latest/advanced_tutorials/basedataset.html>`_ .
