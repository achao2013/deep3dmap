...
from engines.utils import is_filepath
...
class FileClient:
    ...
    Warning:
        ...
        in https://engines.readthedocs.io/en/latest/api/fileio.html#file-io
    ...
    def __new__(cls, backend=None, prefix=None, **kwargs):
        print_log(
            ...
            'functions in '
            'https://engines.readthedocs.io/en/latest/api/fileio.html#file-io',  # noqa: E501
            logger='current',
            level=logging.WARNING)
