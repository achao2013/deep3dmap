...
Engine currently supports five file backends:
...
Examples:
    ...
    >>> import engines.fileio as fileio
...
def copyfile_from_local(
    ...
    Examples:
        >>> # dst is a file
        >>> src = '/path/of/file'
        >>> dst = 's3://deep3dmap/engines/file1'
        >>> # src will be copied to 's3://deep3dmap/engines/file1'
        >>> copyfile_from_local(src, dst)
        s3://deep3dmap/engines/file1

        >>> # dst is a directory
        >>> dst = 's3://deep3dmap/engines'
        >>> # src will be copied to 's3://deep3dmap/engines/file''
        >>> copyfile_from_local(src, dst)
        's3://deep3dmap/engines/file'
    """
    backend = get_file_backend(
...
def copytree_from_local(
    ...
    Examples:
        >>> src = '/path/of/dir'
        >>> dst = 's3://deep3dmap/engines/dir'
        >>> copyfile_from_local(src, dst)
        's3://deep3dmap/engines/dir'
    """
    backend = get_file_backend(
        dst, backend_args=backend_args, enable_singleton=True)
