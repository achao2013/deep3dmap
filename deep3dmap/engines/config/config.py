...
from engines.fileio import dump, load
from engines.logging import print_log
from engines.utils import (check_file_exist, get_installed_path,
...
class Config:
    ...
    Examples:
        ...
        >>> cfg.filename
        "/home/username/projects/engines/tests/data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/username/projects/engines/tests/data/config/a.py]
        :"
    ...
    def _get_base_files(filename: str) -> list:
        ...
        if file_format == '.py':
            ...
            import engines
            cfg_dict = engines.load(filename)
