...
class BaseAveragedModel(nn.Module):
    ...
    In engines, we provide two ways to use the model averaging:

    1. Use the model averaging module in hook:
       We provide an :class:`engines.hooks.EMAHook` to apply the model
    ...
    2. Use the model averaging module directly in the algorithm. Take the ema
       ...
       >>> from engines.model import ExponentialMovingAverage
