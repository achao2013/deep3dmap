...
class BaseModule(nn.Module, metaclass=ABCMeta):
    """Base module for all modules in deep3dmap. ``BaseModule`` is a wrapper of
    ...
    def init_weights(self):
        ...
        if not self._is_init:
            if self.init_cfg:
                ...
                # the previous initialized weights.
                # See details in https://github.com/open-mmlab/engines/issues/691 # noqa E501
                other_cfgs = []
                pretrained_cfg = []
