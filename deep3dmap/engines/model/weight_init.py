...
from engines.registry import WEIGHT_INITIALIZERS, build_from_cfg
...
class PretrainedInit:
    ...
    def __call__(self, module):
        from engines.runner.checkpoint import (_load_checkpoint_with_prefix,
                                                load_checkpoint,
                                                load_state_dict)
...
def initialize(module, init_cfg):
    ...
    Args:
        ...
        init_cfg (dict | list[dict]): initialization configuration dict to
            define initializer. Deep3dMap has implemented 6 initializers
