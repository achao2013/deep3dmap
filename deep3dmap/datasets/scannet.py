...
from deep3dmap.datasets.scannet import collate_fn
import trimesh
...
class ScanNetDataset(Dataset):
    ...
    def evaluate(outputs, data_path, save_path, gt_path, max_depth, num_workers, loader_num_workers, n_proc, n_gpu):
        def process(scene, total_scenes_index, total_scenes_count, 
            ...
            dataset = ScanNetDataset(n_imgs, scene, data_path, max_depth)
