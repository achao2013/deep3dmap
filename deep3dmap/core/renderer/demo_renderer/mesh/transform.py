'''
# 3D-2D project transform (camera)
## camera model. 3d vertices project to 2d
## estimate camera matrix. 2d points and corresponding 3d --> pose parameter
...
# ---- initialize 3dmm parameters(special for bfm)
