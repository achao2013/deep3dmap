...
from deep3dmap.datasets.ns.lerf_datamanager import LERFDataManagerConfig
from deep3dmap.models.frameworks.lerf import LERFModelConfig
from deep3dmap.runners.ns_pipelines.lerf_pipeline import LERFPipelineConfig

"""
Swap out the network config to use OpenCLIP or CLIP here.
"""
from deep3dmap.models.modulars.ns_encoders.clip_encoder import CLIPNetworkConfig
from deep3dmap.models.modulars.ns_encoders.openclip_encoder import OpenCLIPNetworkConfig
from dataclasses import dataclass

@dataclass
class LERFTrainerConfig(TrainerConfig):
    pipeline: LERFPipelineConfig = LERFPipelineConfig()
